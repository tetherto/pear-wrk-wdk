...
const { entropyToMnemonic, mnemonicToSeedSync, mnemonicToEntropy } = require('@scure/bip39', { with: { imports: 'bare-node-runtime/imports' } })
const { wordlist } = require('@scure/bip39/wordlists/english', { with: { imports: 'bare-node-runtime/imports' } })

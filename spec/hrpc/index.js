...
const methods = new Map([
  ['@wdk-core/command-workletStart', 0],
  [0, '@wdk-core/command-workletStart'],
  ['@wdk-core/command-workletStop', 1],
  [1, '@wdk-core/command-workletStop']
])
...
class HRPC {
  constructor (stream) {
    ...
    this._requestEncodings = new Map([
      ['@wdk-core/command-workletStart', getEncoding('@wdk-core/command-workletStart-request')],
      ['@wdk-core/command-workletStop', getEncoding('@wdk-core/command-workletStop-request')]
    ])
    this._responseEncodings = new Map([
      ['@wdk-core/command-workletStart', getEncoding('@wdk-core/command-workletStart-response')],
      ['@wdk-core/command-workletStop', getEncoding('@wdk-core/command-workletStop-response')]
    ])
  ...
  async commandWorkletStart (args) {
    return this._call('@wdk-core/command-workletStart', args)
  }

  async commandWorkletStop (args) {
    return this._call('@wdk-core/command-workletStop', args)
  }

  onCommandWorkletStart (responseFn) {
    this._handlers['@wdk-core/command-workletStart'] = responseFn
  }

  onCommandWorkletStop (responseFn) {
    this._handlers['@wdk-core/command-workletStop'] = responseFn
  }
